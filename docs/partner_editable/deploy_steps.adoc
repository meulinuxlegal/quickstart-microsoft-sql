...
[cols=2*]
|===
^|https://fwd.aws/7j9Ad[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://github.com/aws-quickstart/quickstart-microsoft-sql/blob/main/templates/sql-master.template[View template^]

^|https://fwd.aws/d3wqB[Deploy {partner-product-short-name} into an existing VPC on AWS^]
^|https://github.com/aws-quickstart/quickstart-microsoft-sql/blob/main/templates/sql.template[View template^]
|===
