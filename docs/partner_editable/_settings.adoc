...
:quickstart-project-name: quickstart-microsoft-sql
:partner-product-name: SQL Server with Always On Replication
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: SQL Server with Always On Replication
...
:quickstart-contributors: Aaron Lima and Dave May, AWS Quick Start team
