...
:partner-product-name: SQL Server with Windows Server Failover Clustering
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: SQL Server
...
:quickstart-contributors: Aaron Lima and Dave May, Amazon Web Services
